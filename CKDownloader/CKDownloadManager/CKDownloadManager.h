...
@protocol CKDownloadManagerDelegate <NSObject>

@optional
- (void)downloadManager:(CKDownloadManager *)downloadManager receivedDataForTask:(CKDownloadTask *)downloadTask;
...
@property (nonatomic, weak) id <CKDownloadManagerDelegate> delegate;
